...
{
    internal class StressTestState : BaseState
    {
        ...
        public StressTestState(LevelStateMachine machine, LevelLibrary library) : base(machine, library)
        {
            _levelStateMachine = machine;
            _spawnStates1.Add(new SpawnStructureState(machine, 80, 0, 80, 1, false));
            _spawnStates1.Add(new SpawnStructureState(machine, 50, 0, 80, 1, false));


            _spawnStates2.Add(new SpawnStructureState(machine, 100, 0, 50, 2, false));
            _spawnStates2.Add(new SpawnStructureState(machine, 70, 0, 50, 2, false));


            _spawnStates3.Add(new SpawnStructureState(machine, 80, 0, 80, 3, false));
            _spawnStates3.Add(new SpawnStructureState(machine, 50, 0, 80, 3, false));


            _spawnStates4.Add(new SpawnStructureState(machine, 130, 0, 25, 4, false));
            _spawnStates4.Add(new SpawnStructureState(machine, 100, 0, 25, 4, false));

            _spawnStates5.Add(new SpawnStructureState(machine, 200, 0, 10, 5, false));
            _spawnStates5.Add(new SpawnStructureState(machine, 100, 0, 10, 5, false));
